defmodule Servy.HttpServer do
  ...
  """
  # ports 0 - 1023 reserved for system
  ...
  def accept_loop(listen_socket) do
    ...
    # The controlling process of client_socket would automatically close the socket
    # if the process dies. However client_socket is passed to serve, which runs in
    # a new, spawned process
    # If the spawned process dies (as in the case of /kaboom, which throws an error)
    # it doesn't automatically close the socket (b/c the spawned process is not
    # the controlling process), so a bunch would be left open
    # this makes it the controlling process
